		...
		function roomSocket(){
			...
			socket.on('room-message-new',function(data){
				...
				/*var li = '<li class="message">'
							+'<div class="clearfix">'
								+'<div class="avatar">'
									+'<img src="images/avatars/'+data.authInfo.avatar+'" alt="'+data.authInfo.name+'" width="32" height="32">'
								+'</div>'
								+'<div class="content clearfix">'
									+'<div class="created">'
										+'<i></i> <span>'+data.msg.created+'</span>'
									+'</div>'
									+'<div>'
										+'<div class="fullname">'+data.authInfo.name+'</div>'
