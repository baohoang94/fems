...
(function($){
	$.fn.zSlider = function(options){
		...
		//=============================================
		//Khai bao cac bien se su dung trong Plugin
		//=============================================
		...
		//=============================================
		//Goi ham chay mac dinh khi Plugin dc keu
		//=============================================
		init().done(function(){
		...
		//=============================================
		//Ham chay slider ve phia tay phai
		//=============================================
		function runRight(){
			$(options.pic).animate({
				"left"		: "-920px",
				...
				itemSelected = itemSelected + 1;//1 -2 
			...
			if(itemTotal > 0){
				...
				$(divMark).on({
					...
					mouseleave: function(){
									...
									var markDefault = $(ulThumbs 
														+ " li:eq(" + itemSelected + ") div.mask");
									$(markDefault).addClass("maskHover");
								},
					click	  : function(){
									$(divMark).removeClass("maskHover");
									...
									setPicturePosition();
									console.log($(divMark).index($(this)));
								}
				});
				...
				//Thiet lap hinh mac dinh cho Slider
				setPicturePosition();
				dfd.resolve();
			}else{
				dfd.reject();
		...
		//=============================================
		//Thiet lap vi tri cua cac hinh lon khi vua Plugin
		//=============================================
		function setPicturePosition(){
			...
			$(itemTitle).text(dataArr[itemSelected].title);
			$(itemDetail).text(dataArr[itemSelected].detail);
			//console.log(markDefault);
			
			
		}
		
		//=============================================
		//Ham tinh chieu thuc cua UL
		//=============================================
		function setWidthUL(){
